...
Soon.Name = "Soon"
Soon.Parent = Frame
Soon.BackgroundColor3 = Color3.fromRGB(156, 156, 156)
Soon.BorderColor3 = Color3.fromRGB(0, 0, 0)
Soon.BorderSizePixel = 0
Soon.Position = UDim2.new(0.0257611237, 0, 0.765734732, 0)
Soon.Size = UDim2.new(0, 405, 0, 29)
Soon.Font = Enum.Font.SourceSansBold
Soon.Text = "Soon"
Soon.TextColor3 = Color3.fromRGB(0, 0, 0)
Soon.TextSize = 17.000
Soon.TextXAlignment = Enum.TextXAlignment.Left

UICorner_16.Parent = Soon

Soon_2.Name = "Soon"
Soon_2.Parent = Soon
Soon_2.BackgroundColor3 = Color3.fromRGB(89, 89, 89)
Soon_2.BorderColor3 = Color3.fromRGB(0, 0, 0)
Soon_2.BorderSizePixel = 0
Soon_2.Position = UDim2.new(0.795061707, 0, 0.103448279, 0)
Soon_2.Size = UDim2.new(0, 68, 0, 22)
Soon_2.Font = Enum.Font.SourceSans
Soon_2.Text = "Toggle"
Soon_2.TextColor3 = Color3.fromRGB(255, 255, 255)
Soon_2.TextSize = 14.000
Soon_2.TextStrokeTransparency = 0.300

UICorner_17.Parent = Soon_2
...
local function ARDDZX_fake_script() -- Frame.LocalScript 
	local script = Instance.new('LocalScript', Frame)

	Frame.Active = true
	Frame.Draggable = true
end
coroutine.wrap(ARDDZX_fake_script)()
local function SJDN_fake_script() -- JumpButton.LocalScript 
...
coroutine.wrap(SJDN_fake_script)()
local function EJPH_fake_script() -- NoclipButton.LocalScript 
...
coroutine.wrap(EJPH_fake_script)()
local function CKTP_fake_script() -- FlyButton.LocalScript 
...
coroutine.wrap(CKTP_fake_script)()
local function VGHG_fake_script() -- SpeedButton.LocalScript 
...
coroutine.wrap(VGHG_fake_script)()
local function ARAU_fake_script() -- ESPButton.LocalScript 
...
coroutine.wrap(ARAU_fake_script)()
local function BOYIU_fake_script() -- AimbotButton.LocalScript 
...
coroutine.wrap(BOYIU_fake_script)()
local function SYWP_fake_script() -- TeamCheck.LocalScript 
...
coroutine.wrap(SYWP_fake_script)()
local function REIBM_fake_script() -- Soon_2.LocalScript 
	local script = Instance.new('LocalScript', Soon_2)

	
end
coroutine.wrap(REIBM_fake_script)()
local function NQDDEM_fake_script() -- SWButton.LocalScript 
...
coroutine.wrap(NQDDEM_fake_script)()
local function CORR_fake_script() -- NewStormWareMobile.LocalScript 
...
coroutine.wrap(CORR_fake_script)()
